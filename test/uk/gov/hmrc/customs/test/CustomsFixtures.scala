...
trait CustomsFixtures {
  ...
  protected def userFixture(lastName: String = randomLastName,
    ...
    Enrolments(
      if (eori.isDefined)
        Set(
          Enrolment(SignedInUser.cdsEnrolmentName,
                    Seq(EnrolmentIdentifier(SignedInUser.eoriIdentifierKey, eori.get)),
                    "activated")
        )
      else Set.empty
    )
  ...
  protected def randomSubmitDeclaration: MetaData =
    MetaData(
      declaration = Some(
        Declaration(
  ...
  protected def randomDeclarationFunctionCode: Int =
    declarationFunctionCodes(randomInt(declarationFunctionCodes.length))
  ...
  private lazy val firstNames: Seq[String] = Seq(
    "Oliver",
    "Jack",
    "Harry",
    "Jacob",
  ...
  private lazy val lastNames: Seq[String] =
    Seq("Smith", "Jones", "Williams", "Brown", "Taylor", "Davies", "Wilson", "Evans", "Thomas", "Roberts")
  ...
  private lazy val iso3166: Seq[String] = Seq(
    "AF",
    "AX",
    "AL",
    "DZ",
