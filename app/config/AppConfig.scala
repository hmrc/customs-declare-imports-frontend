...
class AppConfig @Inject()(val runModeConfiguration: Configuration, val environment: Environment)
  ...
  lazy val customsDeclarationsApiVersion: String = getConfString(
  ...
  lazy val cancelImportDeclarationUri: String = getConfString(
    "customs-declarations.cancel-uri",
    throw new IllegalStateException("Missing configuration for Customs Declarations cancel URI")
  )
  lazy val submitImportDeclarationUri: String = getConfString(
    "customs-declare-imports.submit-uri",
