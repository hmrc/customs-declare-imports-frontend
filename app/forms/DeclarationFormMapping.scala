...
object DeclarationFormMapping {
  ...
  )(GovernmentAgencyGoodsItemAdditionalDocumentSubmitter.apply)(
    GovernmentAgencyGoodsItemAdditionalDocumentSubmitter.unapply
  )
  ...
  val measureMapping = mapping(
    "unitCode" -> optional(
      text.verifying("Measurement Unit & Qualifier cannot be more than 5 characters", _.length <= 5)
    ),
    "value" ->
      optional(
        bigDecimal
          .verifying("Quantity cannot be greater than 9999999999.999999", _.precision <= 16)
          .verifying("Quantity cannot have more than 6 decimal places", _.scale <= 6)
          .verifying("Quantity must not be negative", _ >= 0)
      )
  )(Measure.apply)(Measure.unapply)

  val writeOffMapping = mapping("quantity" -> optional(measureMapping), "amount" -> optional(amountMapping))(
    WriteOff.apply
  )(WriteOff.unapply)
  ...
  val govtAgencyGoodsItemAddDocMapping = mapping(
    ...
    "lpcoExemptionCode" -> optional(
      text.verifying("Status must be 2 characters", (str => str.length == 2 && isAlpha(str)))
    ),
    ...
    .verifying(
      ...
      require1Field[GovernmentAgencyGoodsItemAdditionalDocument](_.categoryCode,
                                                                 _.effectiveDateTime,
                                                                 _.id,
                                                                 _.name,
                                                                 _.lpcoExemptionCode,
  ...
  lazy val additionalInformationMapping = mapping(
    ...
    "statementDescription" -> optional(
      text.verifying("Description should be less than or equal to 512 characters", _.length <= 512)
    ),
    "limitDateTime" -> ignored[Option[String]](None),
    "statementTypeCode" -> optional(
      text.verifying("statement type code should be less than or equal to 3 characters", _.length <= 3)
    ),
    "pointers" -> ignored[Seq[Pointer]](Seq.empty)
  )(AdditionalInformation.apply)(AdditionalInformation.unapply)
    .verifying("You must provide Code or Description",
               require1Field[AdditionalInformation](_.statementCode, _.statementDescription))

  val destinationMapping = mapping(
    "countryCode" -> optional(text.verifying("country code is only 3 characters", _.length <= 3)),
    "regionId"    -> optional(text.verifying("regionId code is only 9 characters", _.length <= 9))
  )(Destination.apply)(Destination.unapply)

  val ucrMapping = mapping(
    ...
    "traderAssignedReferenceId" -> optional(
      text.verifying("traderAssignedReferenceId should be less than or equal to 35 characters", _.length <= 35)
    )
  )(Ucr.apply)(Ucr.unapply)

  val exportCountryMapping = mapping(
    "id" -> text.verifying("export Country code should be less than or equal to 2 characters", _.length <= 2)
  )(ExportCountry.apply)(ExportCountry.unapply)

  val valuationAdjustmentMapping = mapping(
    "additionCode" -> optional(
      text.verifying("valuationAdjustment should be less than or equal to 4 characters", _.length <= 4)
    )
  ...
  )(GoodsItemValueInformation.apply)(GoodsItemValueInformation.unapply)

  val addressMapping = mapping(
    "cityName" -> optional(text.verifying("City name should be 35 characters or less", _.length <= 35)),
    "countryCode" -> optional(
      text.verifying("Country code is invalid", code => config.Options.countryOptions.exists(_._1 == code))
    ),
    "countrySubDivisionCode" -> optional(
      text.verifying("Country sub division code should be 9 characters or less", _.length <= 9)
    ),
    "countrySubDivisionName" -> optional(
      text.verifying("Country sub division name should be 35 characters or less", _.length <= 35)
    ),
  ...
  val roleBasedPartyMapping = mapping(
    "id" -> optional(
      text.verifying("Role based party id should be less than or equal to 17 characters", _.length <= 17)
    ), // max 17 chars
  ...
  val governmentProcedureMapping = mapping(
    "currentCode" -> optional(
      text.verifying("Current code should be less than or equal to 2 characters", _.length <= 2)
    ), // max 7 chars
    "previousCode" -> optional(
      text.verifying("Previous code  should be less than or equal to 2 characters", _.length <= 2)
    ) // max 7 chars
  )(GovernmentProcedure.apply)(GovernmentProcedure.unapply)
    .verifying("To add procedure codes you must provide Current Code or Previous code",
               require1Field[GovernmentProcedure](_.currentCode, _.previousCode))
  ...
  val packagingMapping =
    mapping(
      "sequenceNumeric" -> optional(number(0, 99999)), //: Option[Int] = None, // unsigned max 99999
      "marksNumbersId" -> optional(
        text.verifying("marks Numbers Id should be less than or equal to 512 characters", _.length <= 512)
      ), //: Option[String] = None, // max 512 chars
      ...
      "packingMaterialDescription" -> optional(
        text.verifying("packing Material Description should be less than or equal to 256 characters", _.length <= 256)
      ), // Option[String] = None, // max 256 chars
      ...
      "volumeMeasure" -> optional(measureMapping)
  ...
  val chargeDeductionMapping = mapping(
    "chargesTypeCode" -> optional(
      text.verifying("Charges code should be less than or equal to 2 characters", _.length <= 2)
    ),
    "otherChargeDeductionAmount" -> optional(amountMapping) // Option[Amount] = None
  )(ChargeDeduction.apply)(ChargeDeduction.unapply)
    .verifying("Charges code, currency id or amount are required",
               require1Field[ChargeDeduction](_.chargesTypeCode, _.otherChargeDeductionAmount))

  val customsValuationMapping = mapping(
    "methodCode" -> optional(
      text.verifying(" Charges code should be less than or equal to 3 characters", _.length <= 3)
    ), // max 3 chars; not valid outside GovernmentAgencyGoodsItem
    "freightChargeAmount" -> optional(bigDecimal), // default(bigDecimal, None),
    "chargeDeductions"    -> seq(chargeDeductionMapping)
  )(CustomsValuation.apply)(CustomsValuation.unapply)

  val officeMapping = mapping(
    "id" -> optional(
      text
  ...
  val obligationGauranteeMapping =
    mapping(
      ...
      "referenceId" -> optional(
        text.verifying("ReferenceId should be less than or equal to 35 characters", _.length <= 35)
      ),
      "securityDetailsCode" -> optional(
        text.verifying("SecurityDetailsCode should be less than or equal to 3 characters", _.length <= 3)
      ),
      "accessCode" -> optional(
        text.verifying("AccessCode should be less than or equal to 4 characters", _.length <= 4)
      ),
      "guaranteeOffice" -> optional(officeMapping)
    )(ObligationGuarantee.apply)(ObligationGuarantee.unapply)
      .verifying(
        "You must provide a Deferred Reference ID or ID or Amount of import duty and other charges or Access Code or Customs office of guarantee",
        require1Field[ObligationGuarantee](_.referenceId, _.id, _.amount, _.accessCode, _.guaranteeOffice)
      )

  val guaranteesFormMapping = mapping("guarantees" -> seq(obligationGauranteeMapping))(ObligationGuaranteeForm.apply)(
    ObligationGuaranteeForm.unapply
  )
  ...
  val previousDocumentMapping = mapping(
    "categoryCode" -> optional(
      text.verifying("Document Category  should be less than or equal to 1 character", _.length <= 1)
    ), //: Option[String] = None, // max 3 chars
    "id" -> optional(
      text.verifying("Document Reference should be less than or equal to 35 characters", _.length <= 35)
    ), //: Option[String] = None, // max 70 chars
    "typeCode" -> optional(
      text.verifying("Previous Document Type should be less than or equal to 3 characters", _.length <= 3)
    ), //: Option[String] = None, // max 3 chars
    "lineNumeric" -> optional(
      number
        .verifying("Goods Item Identifier should be greater than 0 and less than or equal to 999",
                   lineNumeric => (lineNumeric > 0 && lineNumeric <= 999))
    ) //: Option[Int] = None, // max 99999999
    ...
    .verifying(
      ...
      require1Field[PreviousDocument](_.categoryCode, _.id, _.typeCode, _.lineNumeric)
    )
  ...
  val additionalDocumentMapping = mapping(
    ...
    "categoryCode" -> optional(
      text.verifying("Deferred Payment Category should be less than or equal to 1 character", _.length <= 1)
    ),
    "typeCode" -> optional(
      text.verifying("Deferred Payment Type should be less than or equal to 3 characters", _.length <= 3)
    )
    ...
    .verifying(
      ...
      require1Field[AdditionalDocument](_.id, _.categoryCode, _.typeCode)
    )
  ...
  val referencesMapping = mapping(
    ...
    "functionalReferenceId" -> optional(text.verifying("LRN must be 22 characters or less", _.length <= 22)),
